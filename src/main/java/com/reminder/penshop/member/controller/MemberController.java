...
public class MemberController {
    ...
    @Autowired
    public MemberController(MemberService memberService, KakaoOAuth2Service kakaoOAuth2Service, MailService mailService, MessageSource messageSource, PasswordEncoder passwordEncoder, SignUpValidator signUpValidator) {
