...
public class MypageController {
    ...
    public void getMypage(@AuthenticationPrincipal UserImpl user, HttpSession session, Model model) {
        ...
        if (recentlyViewed != null) {
            ...
            model.addAttribute("recentlyViewedItems", recentlyViewedItems); // 최근 본 상품 조회
            model.addAttribute("recentlyViewedThumbnailList", recentlyViewedThumbnailList);
        }
        model.addAttribute("memberPoint", memberService.getMemberPoint(user.getMemberId())); //현재 보유적립급
     ...
     * */
    @GetMapping("order")
    public void getOrderList(@AuthenticationPrincipal UserImpl user, HttpSession session, Model model) {
    ...
    public void getOrderListDetail(@RequestParam("no") String orderNo, @AuthenticationPrincipal UserImpl user, HttpSession session, Model model) {
